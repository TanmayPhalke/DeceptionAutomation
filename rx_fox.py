...
class rx_fox(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_fox")
        ...
        self.channel_freq = channel_freq = 105e6
        ...
        self._channel_freq_range = Range(30e6, 110e6, 1, 105e6, 200)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/cranky/deception/rx_files/rx_fox.wav',
            2,
            44100,
            blocks.FORMAT_WAV,
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(rf_gain)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_wavfile_sink_0, 1))
    ...
    def set_rf_gain(self, rf_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.rf_gain)
...
def main(top_block_cls=rx_fox, options=None):
    ...
    timer = Qt.QTimer()
    timer.start(int(audio_length * 1000))
    timer.timeout.connect(lambda: os.kill(pid, signal.SIGTERM))
